...
function Home() {
  ...
  // SECURITY: Firestore Rules allow public reads only for published courses.
  // Therefore the homepage must query only published documents. A broad
  // collection query would be rejected by Firestore when logged out.
  useEffect(() => {
    let mounted = true;
